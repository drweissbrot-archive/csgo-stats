...
class CreateMolotovThrownEventsTable extends Migration
{
	public function up()
	{
		Schema::create('molotov_thrown_events', function (Blueprint $table) {
	...
	{
		Schema::dropIfExists('molotov_thrown_events');
	}
}
