...
class CreateSmokeDetonatedEventsTable extends Migration
{
	public function up()
	{
		Schema::create('smoke_detonated_events', function (Blueprint $table) {
	...
	{
		Schema::dropIfExists('smoke_detonated_events');
	}
}
